<template>
  <div>
    <el-row v-if="user">
      <el-col :span="6">
        <el-card class="text-cetner" style="margin-right: 16px">
          <div>
            <img src="https://placehold.it/150x150" style="width: 100%; margin-bottom: 16px; border-radius: 2px;" alt="">
          </div>
          <h2>
            <b>{{ user.id }}</b>
          </h2>
      ...
      <el-col :span="18">
        <el-card>
          ...
          <el-table :data="userPosts" style="width: 100%" class="table">
            ...
            <el-table-column prop="created_at" label="投稿一覧" width="160" />
          </el-table>
        </el-card>
      </el-col>
    </el-row>
